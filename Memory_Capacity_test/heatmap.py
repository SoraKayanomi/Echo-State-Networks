...
#plt.xticks(np.arange(0,np.size(data,1),1),np.arange(origin[0,1],origin[0,-1]+0.02,0.02))
#plt.yticks(np.arange(0,np.size(data,0),1),np.arange(origin[1,0],origin[-1,0]+0.1,0.1))
